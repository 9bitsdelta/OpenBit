...
namespace Bit {
	...
	void Renderer2D::Init()
	{
		...
		s_Data.QuadVertexBuffer = CreateRef<VertexBuffer>(nullptr, s_Data.MaxVertices * sizeof(QuadVertex), BufferType::Dynamic_Draw);
	...
	void Renderer2D::Flush()
	{
		...
		GraphicsAPI::DrawIndexed(s_Data.QuadVertexArray, s_Data.QuadIndexCount);
